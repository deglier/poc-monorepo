...
declare const StyledBox: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {
    bp1: "(min-width: 640px)";
    bp2: "(min-width: 768px)";
...
export declare type BoxProps = React.ComponentProps<typeof StyledBox> & {};
